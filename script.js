...
function theme1(){
    ...
    document.querySelector(".display").style.background="hsl(225,40%,25%)"
    for (let i = 0; i < keys.length-4; i++) {
        keys[i].style.background="hsl(30, 25%, 89%,100%)"
        keys[i].style.boxShadow=" 0 3px 1px 0px hsl(28, 16%, 65%,34%)";
        keys[i].style.color="hsl(221, 14%, 31%,45%)";0
        keys[i].setAttribute("style","input:active,input::backdrop {box-shadow: none;outline: 0;}")
    }

    keys[15].style.background="hsl(6, 63%, 50%,24%)";
    keys[15].style.boxShadow="0 3px 1px 0px hsl(6, 70%, 34%,76%)";
    keys[15].style.color="hsl(0, 0%, 100%,125%)";
    keys[15].setAttribute("style","input:active,input::backdrop {box-shadow: none;outline: 0;}")

    keys[16].style.background="hsl(225, 21%, 49%,54%)";
    keys[17].style.background="hsl(225, 21%, 49%,43%)";

    keys[16].style.boxShadow="0 3px 1px 0px hsl(224, 28%, 35%,107%)";
    keys[17].style.boxShadow="0 3px 1px 0px hsl(224, 28%, 35%,998%)";
    ...
    document.querySelector(".scroll").style.background="hsl(223, 31%, 20%,100%)"

    document.querySelector(".circle").style.background="hsl(6, 63%, 50%,500%)"
